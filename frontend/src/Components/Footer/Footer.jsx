        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul className='space-y-2'>
                    ...
                    <li><Link to ="/our-service" onClick={scrollToTop} className="hover:text-white transition-colors">제공 기술</Link></li>
            ...
            <div>
                ...
                <ul className='space-y-2 text-gray-400'>
                    ...
                    <li>번영로 653번길</li>
                    <li>전화: 010</li>
                    <li>이메일: 109@gmail.com</li>
                </ul>
            </div>
            <div>
                <h3 className="text-xl font-bold mb-4">소셜 미디어</h3>
                <div className="flex space-x-4">
                    <a href="#" className="text-gray-400 hover:text-withe transition-colors"><FaFacebook/></a>
                    <a href="#" className="text-gray-400 hover:text-withe transition-colors"><FaTwitter/></a>
                    <a href="#" className="text-gray-400 hover:text-withe transition-colors"><FaInstagram/></a>
                    <a href="#" className="text-gray-400 hover:text-withe transition-colors"><FaLinkedin/></a>
                </div>
            </div>
        </div>
