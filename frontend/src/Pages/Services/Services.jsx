  ...
  return (
    <div className="container mx-auto px-4 py-32 max-w-7xl">
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-bold text-gary-800 mb-4">
          우리의 서비스
        </h1>
      ...
      <div className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-semibold text-gray-800">10년+ 경험</h3>
            <p className="text-gray-600"> 다양한 산업 분야의 경험</p>
          </div>
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-semibold text-gray-800">전문가 팀</h3>
            <p className="text-gray-600"> 숙련된 개발자와 컨설턴트 구성</p>
          </div>
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-semibold text-gray-800">24/7 지원</h3>
      ...
      <div className="mt-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            ...
            <div
              key={index}
              className="relatetive p-6 bg-white rounded-xl shadow-md"
            >
